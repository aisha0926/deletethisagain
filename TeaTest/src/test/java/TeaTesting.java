...
public class TeaTesting {
    ...
    public void setup(){
        ...
        reports = new ExtentReports("/Users/Aisha/deletethisagain/Reporting/PassionTea.html", true);
    ...
    public void the_correct_web_address() {
       ...
       assertEquals( "http://www.practiceselenium.com/menu.html",
               driver.getCurrentUrl().equals(Constants.HOMEPAGE));
    }
